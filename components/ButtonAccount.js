...
const ButtonAccount = () => {
	...
	return (
		<Popover className="relative z-10">
			{({ open }) => (
				<>
					<Popover.Button className="flex items-center gap-2 bg-white rounded-xl px-3 py-2 shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200 min-w-0">
						{session?.user?.image ? (
							<img
							...
							<div className="w-5 h-5 bg-orange-500 flex justify-center items-center rounded-full shrink-0">
